...
const redirectToMenuPage = () => {
  ...
  const generatePDF = () => {
   ...
   // doc.line(100, 100, 100, 200); // 
    ...
    doc.text(`NIVEL DE CARGA(%): ${state4.Niv}`, 10, 208, { fontSize: 8 });
    doc.text(`PRUEBA DE AUTONOMÍA: ${state4.PrueA}`, 10, 214, { fontSize: 8 });
    doc.text(`TIEMPO DE AUTONOMÍA: ${state4.Tau}`, 10, 220, { fontSize: 8 });
